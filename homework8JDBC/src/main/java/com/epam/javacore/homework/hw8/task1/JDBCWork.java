...
public class JDBCWork {
    private static final String ADD_BOOK_QUERY = "INSERT INTO book (topic, author) VALUES (?, ?) RETURNING *";
    ...
    private static final String DELETE_BOOK_QUERY = "DELETE FROM book";

    public static Book addBook(String topic, String author) {
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        try {
            preparedStatement = ConnectionBase.getConnection().prepareStatement(ADD_BOOK_QUERY);
    ...
    public static Book deleteUser() {
        PreparedStatement preparedStatement = null;
        try {
            preparedStatement = ConnectionBase.getConnection().prepareStatement(DELETE_BOOK_QUERY);
            ResultSet resultSet = preparedStatement.executeQuery();
            return ejectBook(resultSet);
        } catch (SQLException e) {
            e.printStackTrace();
